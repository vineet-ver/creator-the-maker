...
export function ContactForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-ctm-surface border border-ctm-border p-8 sm:p-12 text-center space-y-4 animate-fade-in">
        ...
        <div className="pt-4">
          <button
            ...
            className="text-xs font-mono uppercase text-ctm-red hover:underline tracking-widest"
          >
  ...
  return (
    <form
      ...
      className="bg-ctm-surface border border-ctm-border p-6 sm:p-10 space-y-4"
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-black border border-ctm-border px-3.5 py-3 text-xs font-mono text-white focus:outline-none focus:border-ctm-red"
          />
        </div>
        <div>
          <label className="block text-[10px] font-mono uppercase tracking-widest text-ctm-muted mb-1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full bg-black border border-ctm-border px-3.5 py-3 text-xs font-mono text-white focus:outline-none focus:border-ctm-red uppercase"
          >
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full bg-black border border-ctm-border p-3.5 text-xs font-mono text-white focus:outline-none focus:border-ctm-red leading-relaxed"
        />
      </div>
