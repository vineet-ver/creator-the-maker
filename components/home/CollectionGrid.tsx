        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {COLLECTIONS.map((col, idx) => (
            <Link
              ...
              className="group relative h-[460px] sm:h-[520px] bg-ctm-surfaceSubtle border border-ctm-border hover:border-black transition-all duration-500 overflow-hidden flex flex-col justify-between p-8 shadow-sm hover:shadow-xl"
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                ...
                <span className="w-8 h-8 rounded-none border border-ctm-border bg-white flex items-center justify-center text-black group-hover:border-ctm-red group-hover:text-ctm-red group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all shadow-sm">
              ...
              <div className="relative z-10 space-y-2">
                <h3 className="text-2xl sm:text-3xl font-display font-extrabold uppercase tracking-wide text-black group-hover:text-ctm-red transition-colors">
                  {col.name}
                </h3>
