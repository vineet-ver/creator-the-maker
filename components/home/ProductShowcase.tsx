...
export function ProductShowcase() {
  ...
  return (
    <section className="bg-white border-b border-ctm-border overflow-hidden">
      ...
      <div className="py-24 sm:py-32 border-b border-ctm-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            {/* Image Column */}
            <div className="lg:col-span-7 relative group">
              <div className="relative w-full h-[450px] sm:h-[600px] bg-ctm-surfaceSubtle border border-ctm-border overflow-hidden flex items-center justify-center p-8">
                ...
                />
                <div className="absolute bottom-6 left-6 px-3 py-1.5 bg-white border border-ctm-border text-[10px] font-mono tracking-widest text-black uppercase shadow-sm">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4 py-6 border-y border-ctm-border text-xs font-mono">
                <div>
                  ...
                  <span className="text-black font-semibold">{heat2.capacity}</span>
                </div>
                <div>
                  <span className="text-ctm-muted block uppercase text-[10px]">
                    Dimensions
                  </span>
                  <span className="text-black font-semibold">{heat2.dimensions}</span>
                </div>
                <div>
                  <span className="text-ctm-muted block uppercase text-[10px]">
                    Material
                  </span>
                  <span className="text-black font-semibold">{heat2.material}</span>
                </div>
                <div>
                  <span className="text-ctm-muted block uppercase text-[10px]">
                    Finish
                  </span>
                  <span className="text-black font-semibold">{heat2.finish}</span>
                </div>
                <div>
                  <span className="text-ctm-muted block uppercase text-[10px]">
                    Tare Weight
                  </span>
                  <span className="text-black font-semibold">{heat2.weight}</span>
                </div>
                <div>
                  <span className="text-ctm-muted block uppercase text-[10px]">
                    Warranty
                  </span>
                  <span className="text-black font-semibold">{heat2.warranty}</span>
                </div>
              </div>
