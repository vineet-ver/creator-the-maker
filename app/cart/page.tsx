      ...
      <Container size="wide">
        ...
        {currentItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              {currentItems.map((item) => (
                <div key={item.id} className="py-6 first:pt-0 last:pb-0 flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex items-start justify-between">
                        <Link
                          ...
                          className="text-xl font-display font-bold uppercase text-white hover:text-ctm-red transition-colors"
                        >
                          {item.product.name}
                        </Link>
                        <button
                      ...
                      <div className="mt-2 space-y-1 text-xs font-mono text-ctm-muted">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-ctm-borderSubtle">
                      <div className="flex items-center border border-ctm-border bg-black">
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity - 1)}
                          className="w-8 h-8 flex items-center justify-center text-ctm-muted hover:text-white"
                        >
            ...
            <div className="lg:col-span-4 bg-ctm-surface border border-ctm-border p-6 sm:p-8 space-y-6">
              <h3 className="font-display font-bold text-lg uppercase tracking-wider text-white">
                ORDER SUMMARY
              </h3>

              {/* Free shipping threshold bar */}
              <div className="p-4 bg-black border border-ctm-borderSubtle space-y-2">
              ...
              <div className="space-y-3 text-xs font-mono border-y border-ctm-borderSubtle py-4">
                ...
                <div className="flex justify-between text-ctm-muted">
                  <span>INSURANCE</span>
                  <span className="text-ctm-lightMuted">FULLY INSURED FREIGHT</span>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2 text-[11px] font-mono text-ctm-muted">
