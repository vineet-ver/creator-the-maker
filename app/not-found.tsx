    ...
    <div className="min-h-screen bg-ctm-black flex items-center justify-center pt-24 pb-16">
      <Container size="narrow">
        <div className="text-center space-y-6 bg-ctm-surface border border-ctm-border p-10 sm:p-16">
          ...
          <h1 className="text-6xl sm:text-8xl font-display font-black text-white uppercase tracking-tighter">
            ARCHIVE NOT FOUND<span className="text-ctm-red">.</span>
          </h1>

          <p className="text-sm font-mono text-ctm-muted max-w-md mx-auto leading-relaxed">
